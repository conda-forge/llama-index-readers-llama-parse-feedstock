About llama-index-readers-llama-parse-feedstock
===============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/llama-index-readers-llama-parse-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/llama-index-readers-llama-parse-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add llama-index-readers-llama-parse
# for installing globally
pixi global install llama-index-readers-llama-parse
```
...
It is possible to list all of the versions of `llama-index-readers-llama-parse` available on your platform:
...
```
pixi search llama-index-readers-llama-parse --channel conda-forge
```
